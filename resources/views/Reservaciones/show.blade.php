...
@section('content')
    ...
    <div class="container">
        <h1 class="center-align">Mostrar Reservaciones</h1>
                ...
                <tbody>
                    ...
                    @foreach ($reservaciones as $item)
                        <tr>
                            ...
                            <td>{{ $item->estado }}</td>
                            <td>
                                <a class="btn-small blue btn-editar" href="/Reservaciones/edit/{{ $item->codigo }}"><i
                                        class="material-icons">edit</i></a>
                                <button class="btn-small red btn-eliminar" onclick="destroy(this)"
                                    url="/Reservaciones/destroy/{{ $item->codigo }}" token="{{ csrf_token() }}"><i

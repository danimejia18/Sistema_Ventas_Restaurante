...
@section('content')
  ...
  <div class="container">
    ...
    <div class="table-container">
      ...
      <a href="/Pedidos/create" class="btn-floating btn-large waves-effect waves-light green">
      ...
      <table class="striped responsive-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $item->estado }}</td>
            <td>
              <a class="btn-small blue btn-editar" href="/Pedidos/edit/{{ $item->codigo }}"><i class="material-icons">edit</i></a>

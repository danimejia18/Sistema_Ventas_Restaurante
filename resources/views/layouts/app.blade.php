...
<head>
    ...
    <style>
        ...
        .dropdown-item:hover {
            color: #fff;
            /* Mantener texto blanco al pasar el mouse */
        ...
        .dropdown-menu {
            padding: 0;
            /* Elimina el padding interno del menú */
            margin: 0;
            /* Elimina el margen externo del menú */
            min-width: 100px;
        ...
        .dropdown-item {
            padding: 5px 10px;
            /* Ajusta el padding interno de los elementos */
            line-height: 1.5;
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" role="button" href="/Clientes/show">Clientes</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item" href="/Acceso/show">Accesos</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        ...
                                        <a class="dropdown-item" href="/Mesas/show">Mesas</a>
                                        <a class="dropdown-item" href="/Promociones/show">Promociones</a>

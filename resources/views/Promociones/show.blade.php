...
<body>
  <div class="container">
    <h3 class="center-align">Mostrar Promoción</h3>
    
    <!-- Tabla para mostrar Promoción -->
    <div class="table-container">
      ...
      <table class="highlight responsive-table">
        ...
        <tbody>
          ...
          <tr>
            <td>1</td>
            <td>Especial San Valentín</td>
            <td>Disfruta una comida especial con tu amor especial</td>
            <td>2</td>
            <td>20%</td>
            <td>10/02/2024</td>
            <td>15/02/2024</td>

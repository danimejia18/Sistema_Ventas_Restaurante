...
@section('content')
  ...
  <div class="container">
    ...
    <div class="table-container">
      ...
      <a href="/Menus/create" class="btn-floating btn-large waves-effect waves-light green">
        ...
        <tbody>
          ...
          @foreach ($menus as $item)
              <tr>
                ...
                <td>
                  <a class="btn-small blue btn-editar" href="/Menus/edit/{{$item->codigo}}"><i class="material-icons">edit</i></a>
